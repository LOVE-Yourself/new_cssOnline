...
class UserProfile(AbstractUser):
    ...
    true_name = models.CharField(null=True,blank=True,max_length=50,verbose_name=u'真实姓名')
    ...
    image = models.ImageField(upload_to='image/%Y/%m',default=u'image/aobama.png',max_length=100)
