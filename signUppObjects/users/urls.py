...
from .views import LoginView,LogoutView,RegistView,GetveryCode,ForgetView,UserInfoView,UserUploadImageView,UserUploadPwd,UserCouponView,UserOderView
...
urlpatterns = [
    ...
    url(r'user_order/',UserOderView.as_view(),name='user_order'),
